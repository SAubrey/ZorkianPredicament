...
# Essentially the controller and view of a MVC design, AKA a 'View-Controller',
...
class Game(Observer):
    ...
    def __choose_weapon(self):
        ...
        wep_type = self.__prompt_input("Choose your weapon:", "Your decision must be a number.")
